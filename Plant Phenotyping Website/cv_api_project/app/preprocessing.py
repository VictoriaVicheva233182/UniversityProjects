...
def load_mask_from_bytes(mask_bytes: bytes) -> np.ndarray:
    """
    Load binary mask from bytes (expects grayscale image where mask is 0 or 255).
    """
